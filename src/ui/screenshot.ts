import { VIEWPORT_HEIGHT, VIEWPORT_WIDTH } from "../diagram/viewport";

const EXPORT_SCALE = 4;
const EXPORT_WIDTH = VIEWPORT_WIDTH * EXPORT_SCALE;
const EXPORT_HEIGHT = VIEWPORT_HEIGHT * EXPORT_SCALE;
